...
def user_input_a_variable():
    bulk_setting = st.session_state.bulk_setting
    st.write(f"You are setting a custom value for this variable" )



Planet.Bulk.R_m = st.number_input("Radius of the body (m)", value = planet_module.Planet.Bulk.R_m, key = "Planet.Bulk.R_m", on_change = user_input_a_variable)
